...
def get_input_from_batch(batch, use_cuda):
  ...
  enc_stmts = Variable(torch.from_numpy(batch.enc_stmts).long())
  ...
  return enc_batch, enc_stmts, enc_padding_mask, enc_lens, enc_batch_extend_vocab, extra_zeros, c_t_1, coverage
